...
<?php echo'
  ...
  <div class="login-box">
    <div class="login-logo">
      <div style="background:#1A1A1A;border-radius:30px;padding:10px 15px" class="section text-center">
    ...
    <div class="login-box-body">
      <p class="login-box-msg">LOGIN ADMINISTRATOR</p>
        ...
        <div class="row">
          ...
          <div class="col-xs-12">
            <button type="submit" class="btn btn-dark btn-block" id="login"><i class="fa fa-user"></i> Login</button>
            <a href="../../" class="btn btn-secondary btn-block"><i class="fa fa-home"></i> Home</a>
          </div>
          <!-- /.col -->
        </div>
