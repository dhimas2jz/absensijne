...
if(!isset($_COOKIE['COOKIES_MEMBER']) && !isset($_COOKIE['COOKIES_COOKIES'])){
  ...
  echo'<!-- App Capsule -->
    <div id="appCapsule">
        <!-- Wallet Card -->
        <div class="section wallet-card-dark-section pt-1">
            <div class="wallet-card">
                ...
                <div class="wallet-footer text-center">
                    <div class="webcam-capture-body text-center">
                        ...
                        echo'
                        <button class="btn btn-primary btn-lg btn-block" onClick="captureimage(0)"><ion-icon name="camera-outline"></ion-icon>Absen Pulang</button>';}
                        else{
                        echo'
